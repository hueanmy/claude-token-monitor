...
Before starting non-trivial work, classify the turn against the table below and route accordingly. Source of truth: `.claude/tier_rules.yaml` — this section must be kept in sync with that file.
